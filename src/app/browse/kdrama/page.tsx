...
const GENRES = ['Romance', 'Comedy', 'Action', 'Fantasy', 'Mystery', 'Historical'];
...
export default function KDramaPage() {
  ...
  const { data, isLoading, error } = useContentByType('KDRAMA');
    ...
    <>
      ...
      <main className="min-h-screen bg-dark-900">
        <div className="container mx-auto px-4 py-12">
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-4">K-Dramas</h1>
          ...
          {error ? (
            <p className="text-red-400 text-center py-12">Failed to load K-Dramas. Please try again.</p>
          ) : (
              ...
              {isLoading
                ...
                ? (
                  <p className="col-span-full text-center text-gray-400 py-12">
                    No K-Dramas found{activeGenre ? ` in ${activeGenre}` : ''}.
                  </p>
                )
                : filtered?.map((item) => (
                    <ContentCard
